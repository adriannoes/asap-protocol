...
// Lab II docs ship with v2.5.3 (merge-ready; pending tag/publish).
...
export function WhatsNewRibbon() {
  return (
    <aside
      aria-label="What's new in ASAP Protocol v2.5.3 (merge-ready, pending publish)"
        ...
        <div className="flex items-center gap-2 md:shrink-0 md:border-r md:border-zinc-800 md:pr-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-zinc-500">
              Adapter Lab II · merge-ready · pending tag/publish
            </span>
          </div>
        </div>
