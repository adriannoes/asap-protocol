> [!CAUTION]
> **DEFERRED (2026-02-12, Lean Marketplace Pivot)**: Registry API Backend deferred to v2.1. Lite Registry (GitHub Pages JSON) serves as the discovery mechanism through v2.0. See [deferred-backlog.md](../../../../product-specs/strategy/deferred-backlog.md#1-registry-api-backend-originally-v12-sprints-t3t4).
>
