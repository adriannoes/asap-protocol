> [!CAUTION]
> **DEFERRED (2026-02-12, Lean Marketplace Pivot)**: Production Registry Backend deferred to v2.1. v2.0 Web App reads from Lite Registry (`registry.json` on GitHub Pages). See [deferred-backlog.md](../../../../product-specs/strategy/deferred-backlog.md#1-registry-api-backend-originally-v12-sprints-t3t4).
>
