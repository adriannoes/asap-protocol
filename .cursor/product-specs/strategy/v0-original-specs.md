...
> **Historical document** — This spec reflects the initial v0.1 design. The protocol reached **v1.0.0** (stable) and evolution is driven by the [Roadmap to Marketplace](roadmap-to-marketplace.md) and [Decision Records](../decision-records/README.md). For current scope and future plans (v1.1 Identity, v1.2 Trust, v2.0 Marketplace), see the roadmap and [Agent Marketplace Vision](vision-agent-marketplace.md).
...
| Message types cover essential workflows | ✅ | TaskRequest/Response, TaskUpdate, Envelope — see [Decision Records](../decision-records/README.md) for binding choices |
...
| MCP integration non-invasive | ✅ | MCP envelope approach kept; see [ADR-5](../decision-records/02-protocol.md) |
...
| Security upgrade path clear | ✅ | Bearer/API key in v1.0 → OAuth2 in v1.1 → Signed manifests/mTLS in v1.2; [ADR-8](../decision-records/03-security.md), [ADR-17](../decision-records/03-security.md) |
| Open decisions explicitly documented | ✅ | Section 13; many resolved in [Decision Records](../decision-records/README.md) and [Strategic Decisions](roadmap-to-marketplace.md#strategic-decisions) |
