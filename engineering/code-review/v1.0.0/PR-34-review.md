...
- **Planning**: Reorganized docs with `architecture/`, `references/`, `product/` directories
...
### `product/decision-records/README.md` (New File)
...
*Reviewed against architecture rules in `.cursor/rules/` and roadmap in `engineering/tasks/v1.0.0/`*
