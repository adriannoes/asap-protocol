...
*   **Rationale (Expert View):** Section 3.1 of `engineering/architecture/tech-stack-decisions.md` explicitly mandates the use of **Ed25519** and specifically rejects **ECDSA** ("multiple curves = complexity"). Using ECDSA violates the core signing identity structure (Alignment with MCP, SSH, Signal) and breaks the core protocol compliance standards.
*   **Fix Suggestion:**
