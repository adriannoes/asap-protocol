...
-   **Why not Rust/Go?**: ASAP is I/O-bound, not CPU-bound. Critical performance paths already use Rust internally via dependencies (pydantic-core, orjson). Custom native extensions deferred until profiling identifies specific bottlenecks. See [ADR-9](../../product/decision-records/04-technology.md).
...
-   **Alternatives rejected**: REST (paradigm mismatch for agent actions), gRPC (limited browser support, heavier tooling). See [ADR-2](../../product/decision-records/02-protocol.md).
...
-   **Reference**: [ADR-12](../../product/decision-records/04-technology.md)
...
-   **Alternatives deferred**: NATS/Kafka (overkill for startups, adds infrastructure cost). See [SD-3](../../product/prd/prd-v2.0-roadmap.md).
-   **Reference**: [ADR-3](../../product/decision-records/01-architecture.md)
...
-   **Reference**: [SD-9](../../product/prd/prd-v2.0-roadmap.md), [ADR-13](../../product/decision-records/01-architecture.md)
...
-   **Alternatives deferred**: DNS-SD/mDNS (niche, LAN-only), centralized registry (v1.2). See [SD-10](../../product/prd/prd-v2.0-roadmap.md), [SD-11](../../product/prd/prd-v2.0-roadmap.md), [ADR-14](../../product/decision-records/01-architecture.md), [ADR-15](../../product/decision-records/05-product-strategy.md).
...
-   **Reference**: [ADR-17](../../product/decision-records/03-security.md)
...
-   **Reference**: [SD-4](../../product/prd/prd-v2.0-roadmap.md)
...
-   **Reference**: [Question 10 — Agent evals (deferral)](../../product/decision-records/05-product-strategy.md#question-10-build-vs-buy-for-agent-evals)
...
-   **Reference**: [Question 15 — Lite Registry deferral](../../product/decision-records/05-product-strategy.md#question-15-lite-registry-for-v11-discovery-gap)
...
A key architectural decision spanning all versions. See [ADR-13](../../product/decision-records/01-architecture.md).
