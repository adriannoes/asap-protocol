...
| Homepage hero / CTA copy (agent-first) | S3 | ☑ done (2026-07-18) |
...
| `docs/migration.md` | Section **Upgrading from v2.5.3 → v2.5.4** (S5 finalizes) | ☑ (S5 prep) |
| `README.md` (repo root) | Short pointer to starters/guide if README lists getting-started paths | ☑ (S5 prep) |
...
- [x] Primary hero CTAs → guide and/or `examples/starters/`
- [x] Secondary marketplace CTAs (browse/register) still present
- [x] WhatsNew / Features / How it Works primary actions resolve to live URLs
- [x] `data-cta` IDs listed in `homepage-cta-ids.ts` remain stable or documented if extended
- [x] No pricing / fundraising / private GTM strings (DIST-006)
...
| Item | Owner | Status |
|------|-------|--------|
| §§1–7 for MUST surface | S3 (+ S1/S2 producers) | ☑ web/CTA (§6) done 2026-07-18; MkDocs/docs-home residual items remain producer/S5 |
| DIST-006 grep on touched public copy | S3 | ☑ (homepage landing + metadata; 2026-07-18) |
