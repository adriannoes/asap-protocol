...
**Decision**: `registry.json` lives at repo root (Option A). Public and safe — contains only agent metadata (endpoints, skills, description), no secrets. See [ADR-15 Update (2026-02-19)](../../product/decision-records/05-product-strategy.md#question-15-lite-registry-for-v11-discovery-gap).
...
- [ADR-18](product/decision-records/05-product-strategy.md) — GitHub OAuth + automated PR
