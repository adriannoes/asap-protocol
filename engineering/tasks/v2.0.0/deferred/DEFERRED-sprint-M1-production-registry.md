> [!CAUTION]
> **DEFERRED (2026-02-12, Lean Marketplace Pivot)**: Production Registry Backend deferred to v2.1. v2.0 Web App reads from Lite Registry (`registry.json` on GitHub Pages). See [deferred-backlog.md](../../../../product/decision-records/05-product-strategy.md#question-15-lite-registry-for-v11-discovery-gap).
>
> This sprint file is preserved for reference.

# Sprint M1: Production Registry (DEFERRED)
