> [!CAUTION]
> **DEFERRED (2026-02-12, Lean Marketplace Pivot)**: Service Integration sprint removed. v2.0 Web App reads from Lite Registry — no backend services to integrate. These integrations move to v2.1 when Registry API Backend is built. See [deferred-backlog.md](../../../../product/decision-records/05-product-strategy.md).
>
