...
- `product/design/mobile-strategy.md` - Mobile responsive layouts strategy
- `engineering/tasks/v2.0.0/vercel-deploy-guide.md` - Step-by-step Vercel deploy guide (M1)
...
- [x] 1.1.2 High-fidelity Mockups
  ...
  - **Requirement**: **Theme: "The Clean Architect" (Vercel Inspired)**
    - **Reference**: `/product/design/landing-reference.png`
