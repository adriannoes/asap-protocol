...
>
> **Parent PRD**: [prd-v2.0-roadmap.md](../../../product/prd/prd-v2.0-roadmap.md)
...
>
> **Lean Marketplace Pivot**: Production Registry backend (formerly M1/M2) removed. Web App reads from Lite Registry (`registry.json` on GitHub Pages). No FastAPI backend, no PostgreSQL, no Railway. See [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md).
>
...
> [!NOTE]
> **Deferred from v2.0**: Registry API Backend (to v2.1), Economy Settlement (to v3.0). See [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md).
...
- **PRD**: [prd-v2.0-roadmap.md](../../../product/prd/prd-v2.0-roadmap.md)
- **Deferred Backlog**: [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md)
- **Roadmap**: [roadmap-to-marketplace.md](../../../product/prd/prd-v2.0-roadmap.md)
- **Vision**: [prd-v2.0-roadmap.md](../../../product/prd/prd-v2.0-roadmap.md)
