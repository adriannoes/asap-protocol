...
> **Related**: [ADR-13](../../../product/decision-records/01-architecture.md) (State Management), [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md), [prd-v2.0-roadmap.md](../../../product/prd/prd-v2.0-roadmap.md)
...
- [ADR-13: State Management](../../../product/decision-records/01-architecture.md) — Hybrid strategy, MeteringStore interface
- [ADR-14: Agent Liveness](../../../product/decision-records/01-architecture.md) — Health endpoint
- [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md) — Audit, Economy Settlement
- [prd-v2.0-roadmap.md](../../../product/prd/prd-v2.0-roadmap.md) — Economy Layer
