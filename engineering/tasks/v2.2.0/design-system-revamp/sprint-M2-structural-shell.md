...
**Mobile Reference:** All responsive layout decisions MUST follow `product/design/mobile-strategy.md` — especially the Sidebar → hamburger/Sheet behavior on mobile breakpoints.
