# Deferred backlog (v2.3.0+)

Post-release tracking items referenced from [sprint-S5-release.md](./sprint-S5-release.md) and [release-checklist.md](./release-checklist.md). Primary execution is via **GitHub issues** (label `deferred`).

| Topic | GitHub issue | Notes |
|------|--------------|--------|
| OpenAPI adapter coverage ≥90% | [#139](https://github.com/adriannoes/asap-protocol/issues/139) | S1 acceptance debt |
