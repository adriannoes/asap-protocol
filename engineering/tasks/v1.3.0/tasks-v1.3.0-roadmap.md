...
>
> **Parent PRD**: [prd-v1.3-roadmap.md](../../../product/prd/prd-v1.3-roadmap.md)
...
>
> **Lean Marketplace Pivot**: Audit logging (formerly E4) has been deferred to v2.1+. Metering reframed as observability (visibility, not billing). See [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md).
...
> [!NOTE]
> **Deferred from v1.3**: Credit system (to v3.0), Audit logging (to v2.1+). See [deferred-backlog.md](../../../product/decision-records/05-product-strategy.md).
...
- **PRD**: [prd-v1.3-roadmap.md](../../../product/prd/prd-v1.3-roadmap.md)
