...
**Context**: IdP-generated `sub` claims (`google-oauth2|12345`) don't match ASAP `agent_id` values (`urn:asap:agent:bot`). Custom Claims provide a portable, standards-based solution. See [ADR-17](../../../product/decision-records/README.md#question-17-trust-model-and-identity-binding-in-v11).
