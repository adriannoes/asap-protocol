> [!CAUTION]
> **DEFERRED (2026-02-12, Lean Marketplace Pivot)**: DeepEval integration deferred to v2.2+. Release tasks moved to new Sprint T4 (Testing & Release). See [deferred-backlog.md](../../../../product/decision-records/05-product-strategy.md#question-10-build-vs-buy-for-agent-evals).
>
