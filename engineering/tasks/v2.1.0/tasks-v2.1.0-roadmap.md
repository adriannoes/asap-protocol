...
>
> **Parent PRD**: [prd-v2.1-ecosystem.md](../../../product/prd/prd-v2.1-ecosystem.md)
...
- **PRD**: [prd-v2.1-ecosystem.md](../../../product/prd/prd-v2.1-ecosystem.md)
- **ADR-24**: MCP Python vs npm (05-product-strategy.md)
- **ADR-25**: SDK cache strategy (04-technology.md)
- **Next**: [prd-v2.2-scale.md](../../../product/prd/prd-v2.2-scale.md)
