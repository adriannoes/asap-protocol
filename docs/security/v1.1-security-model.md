...
> See [ADR-17](../../.cursor/product-specs/decision-records/03-security.md) for the decision record.
...
- [ADR-17: Trust Model and Identity Binding](../../.cursor/product-specs/decision-records/03-security.md)
