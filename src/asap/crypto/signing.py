...
def canonicalize(manifest: Manifest) -> bytes:
    """JCS (RFC 8785) canonical bytes; excludes signature field."""
...
def sign_manifest(
    ...
    """Canonicalize with JCS, sign with Ed25519; returns SignedManifest with 64-byte signature (base64)."""
...
def verify_manifest(
    ...
    """RFC 8032 strict verification; enforces alg ed25519. Uses public_key arg or signed_manifest.public_key. Raises SignatureVerificationError on failure."""
