...
class TestASAPClientCoverageGaps:
        ...
        def mock_transport(request: httpx.Request) -> httpx.Response:
            ...
            return create_mock_response(
                Envelope(
                    ...
                    payload=TaskResponse(task_id="t", status=TaskStatus.COMPLETED, result={}).model_dump(),
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_records_failure_on_exhausted_5xx(self, sample_request_envelope: Envelope) -> None:
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_records_failure_on_exhausted_connect_error(self, sample_request_envelope: Envelope) -> None:
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_records_failure_on_exhausted_429(self, sample_request_envelope: Envelope) -> None:
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_records_failure_on_exhausted_timeout(self, sample_request_envelope: Envelope) -> None:
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_records_failure_on_400_error(self, sample_request_envelope: Envelope) -> None:
