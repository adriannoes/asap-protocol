...
async def test_circuit_breaker_persistence():
    ...
    assert isinstance(excinfo.value, CircuitOpenError) or isinstance(excinfo.value.__cause__, CircuitOpenError)
    
    print("Test passed: Circuit Breaker persisted state across clients.")
