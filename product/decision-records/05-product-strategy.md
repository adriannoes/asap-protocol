...
>
> **Update (2026-02-12, Lean Marketplace Pivot)**: DeepEval integration deferred to v2.2+. v1.2 focuses exclusively on Protocol Compliance (Shell) using the ASAP Compliance Harness. See [Question 10](#question-10-build-vs-buy-for-agent-evals).
...
>
> **Update (2026-02-12, Lean Marketplace Pivot)**: Lite Registry continues as the primary data source through v2.0 (Web App reads from `registry.json`). Full Registry API Backend deferred to v2.1. The Lite Registry proved sufficient and reduces infrastructure complexity. See [Question 15](#question-15-lite-registry-for-v11-discovery-gap).
>
...
> 4. **Category/tags**: Deferred to v2.1. Documented in [Question 22](#question-22-register-agent-template-and-registry-metadata-trust-discovery-other-platforms).
>
