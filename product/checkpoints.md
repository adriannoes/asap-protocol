...
> **Created**: 2026-02-06
> **Updated**: 2026-07-18 — **v2.5.4** Distribution Loop **shipped** (tag [`v2.5.4`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.4); PyPI **2.5.4**; [#294](https://github.com/adriannoes/asap-protocol/pull/294)). Soft successor = **v2.5.5** Formal Spec; long-term = **v3.0** Economy (trigger-gated).
...
- **Shipped (2026-07-18):** `pyproject.toml` **`version = "2.5.4"`** on `main` (Distribution Loop). Tag [`v2.5.4`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.4); PyPI `asap-protocol==2.5.4`; merge [#294](https://github.com/adriannoes/asap-protocol/pull/294). Scope: [prd-v2.5.4-distribution-loop.md](./prd/prd-v2.5.4-distribution-loop.md).
...
| **v2.5.4 — Distribution Loop** | **Released** **2026-07-18** — thin starters, Build for agents guide, homepage agent-first CTAs, telemetry ops. Tag [`v2.5.4`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.4); PyPI **2.5.4**; PR [#294](https://github.com/adriannoes/asap-protocol/pull/294). [PRD](./prd/prd-v2.5.4-distribution-loop.md), [`CHANGELOG`](../CHANGELOG.md#254---2026-07-18), [migration](../docs/migration.md#upgrading-from-v253-to-v254); tasks [tasks-v2.5.4-roadmap.md](../engineering/tasks/v2.5.4/tasks-v2.5.4-roadmap.md). | Handoff → Spec §11; optional Dist metrics → v3.0 proxies. |
...
| 2026-07-18 | **v2.5.4 ship**: tag [`v2.5.4`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.4); PyPI **2.5.4**; [#294](https://github.com/adriannoes/asap-protocol/pull/294); post-publish swap; next → Spec |
