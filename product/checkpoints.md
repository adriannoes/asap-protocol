...
> **Created**: 2026-02-06
> **Updated**: 2026-07-08 — **v2.5.2 shipped** (tag [`v2.5.2`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.2)); train: Adapter Lab II → **v2.5.3**; Distribution Loop → **v2.5.4**; Formal Spec → **v2.5.5**.
