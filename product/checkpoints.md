...
> **Created**: 2026-02-06
> **Updated**: 2026-07-08 — Train rescope: **v2.5.2** = security follow-up (READY TO SHIP); Adapter Lab II → **v2.5.3**; Distribution Loop → **v2.5.4**; Formal Spec → **v2.5.5**.
...
- **Shipped on `main` (2026-06-26):** `pyproject.toml` **`version = "2.5.1"`**. Tags: [`v2.5.1`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.1) (code quality patch, merge [#244](https://github.com/adriannoes/asap-protocol/pull/244)); [`v2.5.0`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.0) (MCP Auth Bridge); [`v2.5.0.1`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.0.1) (**compliance-only** → PyPI `asap-compliance` **1.3.0**). PyPI `asap-protocol` **2.5.1**. npm `@asap-protocol/*` **2.4.1**. **v2.5.1** was rescoped from Adapter Lab II to a behavior-preserving quality patch; Adapter Lab II later moved to **v2.5.3** when **v2.5.2** absorbed the security follow-up (2026-07-08).
- **Next ship:** **v2.5.2** security & correctness follow-up — code merged on `main` ([prd-v2.5.2-security-follow-up.md](./prd/prd-v2.5.2-security-follow-up.md)); tag pending.
- **v2.5.0** MCP Auth Bridge shipped **2026-06-24** (tag [`v2.5.0`](https://github.com/adriannoes/asap-protocol/releases/tag/v2.5.0)).
...
| **v2.5.1 — Code quality patch** | **Released** **2026-06-26** — behavior-preserving refactor (transport/server, client, websocket, SQLite storage, auth, integrations) + six P0 correctness/security fixes (atomic `revoke_cascade`, `usage_events` DDL, unified Host-JWT verifier, **WS now enforces OAuth2**, OpenAPI handler cleanup, client `correlation_id` binding). PR [#244](https://github.com/adriannoes/asap-protocol/pull/244) (code review CR#1–#7 addressed; CR#2/#3/#5/#6/#7 fixed, follow-ups → [#245](https://github.com/adriannoes/asap-protocol/issues/245)–[#249](https://github.com/adriannoes/asap-protocol/issues/249)). Tag **v2.5.1**; PyPI/Docker/GitHub Release via [sprint-S4-release.md](../engineering/tasks/private/v2.5.1/sprint-S4-release.md). ([`CHANGELOG.md`](../CHANGELOG.md#251---2026-06-25), [migration](../docs/migration.md#upgrading-from-v250-to-v251)). | Follow-ups #245–#249 **closed** in v2.5.2 train; Adapter Lab II → **v2.5.3**. |
| **v2.5.2 — Security follow-up** | **READY TO SHIP** on `main` — #209 (operator auth, `extra="forbid"`, Redis JTI, web rate limits) + CR #245–#249 + registry #224/#227 + deps #258. [PRD](./prd/prd-v2.5.2-security-follow-up.md). | Tag `v2.5.2`; close [#209](https://github.com/adriannoes/asap-protocol/issues/209); CP-7 for 2.5.2. |
| **After v2.5.2** | Train rescope documented (2026-07-08): Adapter Lab II → **v2.5.3**, Distribution Loop → **v2.5.4**, Formal Spec → **v2.5.5**. | Kickoff `engineering/tasks/v2.5.3/` when adoption signal opens. |

**Sources of truth for current execution**: [prd-v2.5-roadmap.md](./prd/prd-v2.5-roadmap.md), [prd-v2.5.2-security-follow-up.md](./prd/prd-v2.5.2-security-follow-up.md), [AGENTS.md](../AGENTS.md).
...
| 2026-07-08 | **Train rescope**: v2.5.2 = security follow-up (READY TO SHIP); Adapter Lab II → v2.5.3; Distribution Loop → v2.5.4; Formal Spec → v2.5.5; PRDs renamed; [prd-v2.5.2-security-follow-up.md](./prd/prd-v2.5.2-security-follow-up.md) created. |
