...
| **v2.5.3 — Adapter Lab II** | **✅ Merge-ready (2026-07-14)** | `prd-v2.5.3-adapter-lab-ii.md` + [tasks](../engineering/tasks/v2.5.3/tasks-v2.5.3-roadmap.md) | Workflow connectors, automation security, experimental MAF / NAT; tag pending |
