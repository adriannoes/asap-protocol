...
| v2.5.3 — Adapter Lab II | 🔭 Ready for kickoff | `prd-v2.5.3-adapter-lab-ii.md` + [tasks](../engineering/tasks/v2.5.3/tasks-v2.5.3-roadmap.md) | Enterprise/workflow adapters (ex v2.3.2) |
