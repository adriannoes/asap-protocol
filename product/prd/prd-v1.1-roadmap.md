...
v1.1.0 is the first step toward the Agent Marketplace (v2.0). See [roadmap-to-marketplace.md](./prd-v2.0-roadmap.md) for evolution path.
...
- **Tasks**: [tasks-v1.1.0-roadmap.md](../../engineering/tasks/v1.1.0/tasks-v1.1.0-roadmap.md)
- **Detailed Auth**: [Sprint S1](../../engineering/tasks/v1.1.0/sprint-S1-oauth2-foundation.md)
- **Detailed Discovery**: [Sprint S2](../../engineering/tasks/v1.1.0/sprint-S2-wellknown-discovery.md)
- **Detailed State Storage**: [Sprint S2.5](../../engineering/tasks/v1.1.0/sprint-S2.5-state-storage.md)
- **Detailed Transport**: [Sprint S3](../../engineering/tasks/v1.1.0/sprint-S3-websocket-binding.md), [Sprint S4](../../engineering/tasks/v1.1.0/sprint-S4-webhooks-release.md)
