...
The ASAP Protocol currently lacks a unified, premium visual identity across its web applications. We have recently formalized a new Design System (`product/design/design-system.md`) focused on a "Clean Architect" aesthetic, utilizing Next.js 15, Tailwind v4, Shadcn, Framer Motion, and WebGL. 
...
- **Source of Truth**: All implementations MUST strictly follow `product/design/design-system.md`.
- **Mobile Strategy**: Responsive behavior MUST follow `product/design/mobile-strategy.md` (Sidebar → hamburger, Bento Grid → single-column, etc.).
- **References**:
