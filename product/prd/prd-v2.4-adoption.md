...
v2.4 is the **Spec & Interop** release. v2.3.x focuses on adoption loops and framework adapters; v2.4 should begin only when those loops produce enough external demand to justify standards-track and cross-protocol work.
...
| Prerequisite | Source |
|-------------|--------|
| v2.3.x Adoption train released and measured | v2.3 PRD + private patch PRDs |
| TypeScript SDK stable | v2.3 |
| Capability model stable | v2.2+ |
| Identity model stable | v2.2+ |
| MCP / standards demand validated | 3+ MCP operators or standards-body engagement |
