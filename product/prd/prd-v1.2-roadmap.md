...
> [!NOTE]
> **Lean Marketplace Pivot**: Registry API Backend and DeepEval Intelligence are deferred. See [deferred-backlog.md](../decision-records/05-product-strategy.md).

### 1.2 Strategic Context

v1.2.0 is the second step toward the Agent Marketplace (v2.0). See [roadmap-to-marketplace.md](./prd-v2.0-roadmap.md) for evolution path.
...
- **Tasks**: [tasks-v1.2.0-roadmap.md](../../engineering/tasks/v1.2.0/tasks-v1.2.0-roadmap.md)
- **PKI Details**: [Sprint T1](../../engineering/tasks/v1.2.0/sprint-T1-ed25519-pki.md), [Sprint T2](../../engineering/tasks/v1.2.0/sprint-T2-trust-levels-mtls.md)
- **Evals Details**: [Sprint T3](../../engineering/tasks/v1.2.0/sprint-T3-compliance-harness.md), [Sprint T4](../../engineering/tasks/v1.2.0/sprint-T4-testing-release.md)
- **Deferred Backlog**: [deferred-backlog.md](../decision-records/05-product-strategy.md)
- **Roadmap**: [roadmap-to-marketplace.md](./prd-v2.0-roadmap.md)
- **Vision**: [prd-v2.0-roadmap.md](./prd-v2.0-roadmap.md)
