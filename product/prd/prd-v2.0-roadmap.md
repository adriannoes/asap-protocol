...
> [!NOTE]
> **Lean Marketplace approach**: No backend API. The Web App reads from the Lite Registry (SD-11). A full Registry API Backend is deferred to v2.1. See [deferred-backlog.md](../decision-records/05-product-strategy.md).
...
- **Tasks**: [tasks-v2.0.0-roadmap.md](../../engineering/tasks/v2.0.0/tasks-v2.0.0-roadmap.md)
- **Deferred scope / pivots**: [05-product-strategy.md](../decision-records/05-product-strategy.md)
- **Marketplace narrative**: This PRD (above); economy layer — [prd-v3.0-economy.md](./prd-v3.0-economy.md)
- **v1.3 PRD**: [prd-v1.3-roadmap.md](./prd-v1.3-roadmap.md)
- **Usage Foundation**: [v2.0-marketplace-usage-foundation.md](../../engineering/tasks/v2.0.0/v2.0-marketplace-usage-foundation.md) — Storage, control model, evolution path for central dashboard
...
| Date | Version | Change |
|------|---------|--------|
| 2026-05-04 | — | Cross-link: [PRD v2.3.0 Adoption Multiplier](./prd-v2.3-scale.md) shipped as **v2.3.0** (OpenAPI adapter, TypeScript SDK, auto-registration, escalation, ASAP challenge); see root `CHANGELOG.md` and `docs/migration.md`. |
