...
> [!NOTE]
> **Lean Marketplace Pivot**: Audit logging and credit system are deferred. See [deferred-backlog.md](../decision-records/05-product-strategy.md).

### 1.2 Strategic Context

v1.3.0 is followed by **v1.4.0 (Hardening)** before the v2.0 Marketplace. See [roadmap-to-marketplace.md](./prd-v2.0-roadmap.md).
...
- **Tasks**: [tasks-v1.3.0-roadmap.md](../../engineering/tasks/v1.3.0/tasks-v1.3.0-roadmap.md)
