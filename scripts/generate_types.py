...
def main() -> None:
    ...
    with open(output_file, "w") as out:
        ...
        out.write(" * DO NOT MODIFY IT BY HAND. Instead, modify the source Pydantic models.\n */\n\n")
    ...
    for sf in schema_files:
        ...
        try:
            ...
            result = subprocess.run(cmd, capture_output=True, text=True, cwd="apps/web", check=False)
    ...
    print(f"\n✨ Successfully generated TypeScript types at {output_file}")
