#!/bin/bash
# Test upgrade from v0.3.0 to v0.5.0
# This script creates a clean environment, installs v0.3.0, tests it, then upgrades to v0.5.0
#
# Version History:
# - v0.1.0 (2026-01-23): Initial alpha release
# - v0.3.0 (2026-01-26): Test infrastructure improvements (starting point)
# - v0.5.0 (2026-01-28): Security-hardened release (upgrade target)

set -e

TEST_DIR="/tmp/test-asap-upgrade-v0.3.0"
VENV_DIR="${TEST_DIR}/venv"
SCRIPT_DIR="${TEST_DIR}/test_script.py"

echo "=========================================="
echo "ASAP Protocol Upgrade Test: v0.3.0 -> v0.5.0"
...
# Install v0.3.0
echo ""
echo "Step 2: Installing asap-protocol v0.3.0..."
pip install --upgrade pip
pip install asap-protocol==0.3.0

# Verify installation
echo ""
echo "Step 3: Verifying v0.3.0 installation..."
python -c "import asap; print(f'Installed version: {asap.__version__}')"

# Create test script
cat > "$SCRIPT_DIR" << 'EOF'
"""Simple test script using v0.3.0 ASAP API."""
from asap.models.entities import Capability, Endpoint, Manifest, Skill
from asap.transport.handlers import HandlerRegistry, create_echo_handler
from asap.transport.server import create_app

def main():
    print("Testing v0.3.0 ASAP API...")
    
    # Create manifest using v0.3.0 API
    manifest = Manifest(
    ...
    print("✅ All v0.3.0 API calls succeeded")
...
# Run test with v0.3.0
echo ""
echo "Step 4: Testing with v0.3.0..."
python "$SCRIPT_DIR"
...
print("✅ v0.3.0 code works without modifications in v0.5.0")
PYTHON_EOF
...
echo ""
echo "Summary:"
echo "  - v0.3.0 installed and tested"
