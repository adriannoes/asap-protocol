...
- **Active Sprint**: [engineering/tasks/v2.5.3/](engineering/tasks/v2.5.3/tasks-v2.5.3-roadmap.md) — Adapter Lab II (**S4 merge-ready**; tag pending)
- **Adoption Roadmap**: v2.5.3 **Adapter Lab II** merge-ready (2026-07-14); v2.5.2 **security follow-up** shipped (2026-07-08, tag `v2.5.2`); v2.5.1 **code quality patch** shipped (2026-06-26); v2.5.0 **MCP Auth Bridge** shipped (2026-06-24); `asap-compliance` **1.3.0** on PyPI (tag `v2.5.0.1`); **next adoption:** Distribution Loop (**v2.5.4** — [PRD](product/prd/prd-v2.5.4-distribution-loop.md)); `@asap-protocol/mcp-auth` (HTTP/SSE) still deferred.
